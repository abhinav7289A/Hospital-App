...
export const login = catchAsyncErrors(async(req,res,next)=> {
    ...
    if(password !== confirmPassword){
        return next(new ErrorHandler("Password and confirmed Password donot match", 400))
    }
...
export const logoutPatinet = catchAsyncErrors(async(req,res,next)=>{
...
export const addNewDoctor = catchAsyncErrors(async(req,res,next)=> {
    ...
    if(!cloudinaryResponse || cloudinaryResponse.error){
        console.error("Cloudiary Error:", cloudinaryResponse.error || "Uknown Cloudinary Error!")
    }
